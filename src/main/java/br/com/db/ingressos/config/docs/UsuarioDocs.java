...
public interface UsuarioDocs {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "201", description = "Usuário incluído com sucesso", content = @Content(schema = @Schema(implementation = UsuarioResposta.class))),
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Usuários listados com sucesso", content = @Content(schema = @Schema(implementation = UsuarioResposta.class))),
                        @ApiResponse(responseCode = "404", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = br.com.db.ingressos.exception.EntityNotFoundException.class))),
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Usuário encontrado com sucesso", content = @Content(schema = @Schema(implementation = UsuarioResposta.class))),
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Usuário atualizado com sucesso", content = @Content(schema = @Schema(implementation = UsuarioAtualizadoResposta.class))),
                        @ApiResponse(responseCode = "400", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = EntityBadRequestException.class))),
                        @ApiResponse(responseCode = "404", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = EntityNotFoundException.class))),

        })
        ResponseEntity<UsuarioAtualizadoResposta> atualizarUsuario(
                        @RequestBody @Valid UsuarioAtualizadoResposta usuarioAtualizadoResposta);

        @Operation(summary = "Exclui o usuário.", tags = "usuario")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Usuário excluído com sucesso", content = @Content(schema = @Schema(implementation = UsuarioResposta.class))),
                        @ApiResponse(responseCode = "404", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = EntityNotFoundException.class))),
